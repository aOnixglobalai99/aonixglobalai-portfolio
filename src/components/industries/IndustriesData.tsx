...
const categories = [
  HealthCareServices,
  FinancialServices,
  TelecomNetworkingServices,
  AviationAerospaceTechnology,
  ECommerceRetailTech,
  CybersecurityDataProtection,
  EducationELearningTechnology,
  CloudComputingSaaSSolutions,
  AutomotiveSmartMobility,
  BlockchainWeb3Solutions,
  AIMachineLearningSolutions,
  ManufacturingIndustrialAutomation,
];
