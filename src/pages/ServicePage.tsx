  ...
  return (
    <div>
        ...
        <div className="relative h-full container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-full flex flex-col items-start justify-center w-full max-w-[1140px] mx-auto px-4">
            <div className="space-y-6 animate-fade-in-left">
              ...
              <h1 className="text-white font-black text-[clamp(1.5rem,5vw,2.5rem)] max-w-[600px] leading-tight">
      ...
      <div className="mb-[100px]">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:w-[1140px] mx-auto">
          ...
          <div className="w-full px-4 md:px-0 md:w-[90%] lg:w-full xl:w-[1140px] mx-auto">
            {/* Services Grid */}
